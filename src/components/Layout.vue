    ...
    <div class="main-content">
      ...
      <aside class="sidebar">
        <el-menu :default-active="activeMenu" class="sidebar-menu" router>
          ...
          <el-menu-item index="/admin/vehicle-management" v-if="userRole === 'admin'">
            <el-icon><Car /></el-icon>
            <span>车辆管理</span>
          </el-menu-item>
...
import { MapLocation, Van, Ticket, Document, Warning, User, Setting, DataAnalysis, Car } from '@element-plus/icons-vue'
